...
awful.keyboard.append_global_keybindings{
   ...
   awful.key{
      ...
      group       = 'launcher',
      on_press    = function() awful.spawn(apps.options) end,
   },
   awful.key{
      modifiers   = {mod.super},
      key         = 'space',
   ...
   awful.key{
      ...
      group       = 'launcher',
      on_press    = function() awful.spawn(apps.discord) end,
   },
   awful.key{
      modifiers   = {mod.super},
      key         = 'n',
      ...
      group       = 'utility',
      on_press    = function() awful.spawn(apps.dnd) end,
   },
   awful.key{
      modifiers   = {mod.super, mod.shift},
      key         = 's',
      ...
      group       = 'utility',
      on_press    = function() awful.spawn(apps.snip) end,
   },
   awful.key{
      modifiers   = {mod.super},
      key         = 's',
      description = 'screenshot main display',
      group       = 'utility',
   ...
   awful.key{
      ...
      group       = 'utility',
      on_press    = function() awful.spawn(apps.update) end,
   },
   awful.key{
      modifiers   = {mod.super},
      key         = 'p',
      ...
      group       = 'utility',
      on_press    = function() awful.spawn(apps.compositor) end,
   },
   awful.key{
      modifiers   = {mod.super},
      key         = 'v',
      ...
      group       = 'utility',
      on_press    = function() awful.spawn(apps.replay) end,
   },
   awful.key{
      modifiers   = {mod.super, mod.shift},
      key         = 'q',
      description = 'click to kill',
      group       = 'utility',
      on_press    = function() awful.spawn("xkill") end,
   },
   awful.key{
      modifiers   = {mod.super},
      key         = 'pause current app',
      description = 'pause current app',
      group       = 'utility',
      on_press    = function() awful.spawn(apps.pause) end,
   },
