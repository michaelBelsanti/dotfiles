...
(setq user-full-name "Michael Belsanti"
      user-mail-address "quasigod-io@protonmail.com")
...
;; This section makes Cascadia's ligatures work, remove/comment if you switch fonts.
;; (let ((alist '((33 . ".\\(?:\\(?:==\\|!!\\)\\|[!=]\\)")
;;                (35 . ".\\(?:###\\|##\\|_(\\|[#(?[_{]\\)")
;;                (36 . ".\\(?:>\\)")
;;                (37 . ".\\(?:\\(?:%%\\)\\|%\\)")
